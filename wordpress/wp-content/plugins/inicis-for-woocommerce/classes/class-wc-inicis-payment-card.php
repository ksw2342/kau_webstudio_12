	...
	if ( ! class_exists( 'WC_Gateway_Inicis_Card' ) ) {
		...
		class WC_Gateway_Inicis_Card extends WC_Gateway_Inicis {
			public function __construct() {
				...
				$this->id = 'inicis_card';
				$this->method_title = __('일반 신용카드', 'inicis_payment');
				...
				if( empty($this->settings['title']) ){
					$this->title =  __('일반 신용카드', 'inicis_payment');
					$this->description = __('일반 신용카드로 결제를 진행합니다.', 'inicis_payment');
				}else{
            ...
            function thankyou_page( $order_id ) {
                echo __('일반 신용카드로 결제되었습니다. 감사합니다.', 'inicis_payment');
            }
