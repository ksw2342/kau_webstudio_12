...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            <?php
            //$homeSettings    = get_option('cUs_CtCt_settings_HOME');
            $homeSettings    = get_option('cUs_CtCt_HOME_settings');
//            if(!empty($homeSettings)){
//                update_option('cUs_CtCt_settings_HOME', $homeSettings);
//                $homeSettings    = get_option('cUs_CtCt_settings_HOME');
...
//            }
            ...
            <form name="page-form-home" id="page-form-home">
                ...
                <input type="hidden" name="action" value="cUs_CtCt_setPageSettingsHome">
            </form>
        </tr>
        <!-- FORM TR END -->
    ...
    <?php
        ...
        if (is_array($mypages)) {
            foreach ($mypages as $page) {
                $pageSettings = get_post_meta($page->ID, 'cUs_CtCt_FormByPage_settings', true);
                ?>
                ...
                <tr class="form_placement_item">
                    ...
                    <form name="page-form-<?php echo $page->ID; ?>" id="page-form-<?php echo $page->ID; ?>">
                        ...
                        <td>
                            ...
                            <select class="form-control form_key_byPage" name="form-key" data-pageid="<?php echo $page->ID; ?>">
                                ...
                                if ($cUs_CtCt_API_getFormKeys) {
                                    ...
                                    update_option('cUs_CtCt_settings_form_thumbs', $aryFormThumbs );//UPDATE FORM SETTINGS
                                }
                                ?>
                            </select>
                            <script>
                        ...
                        <input type="hidden" name="action" value="cUs_CtCt_setPageSettings">
...
<script>
    ...
    cUs_CtCt_myjq(document).ready(function($) {
        ...
        $('.form_key_byPage').change(function(){
            ...
            var oFormData = 'action=cUs_CtCt_setFormKeyByPage';
