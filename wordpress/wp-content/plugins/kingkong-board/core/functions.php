...
*/
  ...
  function kkb_loop_column_number($content, $entry, $entry_id, $cnt){
    ...
    if($entry_type == 1){
      $content = "<td class='kingkongboard-list-".$entry['value']."'>".apply_filters('kkb_list_icon_notice', '<span class="kkb-list-icon kkblc-notice" alt="'.__('공지사항', 'kingkongboard').'" title="'.__('공지사항', 'kingkongboard').'">'.__('공지사항 입니다.', 'kingkongboard').'</span>', $entry_id)."</td>";
